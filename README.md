...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aws-error-utils-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13639&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aws-error-utils-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aws-error-utils` can be installed with:

```
conda install aws-error-utils
```

It is possible to list all of the versions of `aws-error-utils` available on your platform with:
